<footer>
    <div class="upper_footer">
        <p>TrueDoctors S.r.l. © 2021 - Tutti i diritti riservati</p>
    ...
    <div class="made_from">
        Made with <i class="fas fa-heart"></i> by: Attanasio, Bonavoglia, D'Amico, Lepore, Pretelli.
    </div>
