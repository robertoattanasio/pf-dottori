            ...
            <form action="{{route('return-edit-profile')}}" method="post">
                ...
                <div class="form-auth-item">
                    ...
                    <div class="auth-item-input">
                        <input id="name" value="{{ Auth::user()->name }}" type="text" class="form-control @error('name') is-invalid @enderror"
                ...
                <div class="form-auth-item">
                    ...
                    <div class="auth-item-input">
                        <input id="city" value="{{ Auth::user()->city }}" type="text" class="form-control @error('city') is-invalid @enderror"
                ...
                <div class="form-auth-item">
                    <label for="phone_number">{{ __('Phone Number') }}</label>
                        ...
                        <div class="auth-item-input">
                            <input id="phone_number" value="{{ Auth::user()->phone_number }}" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number" autofocus>
                                @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="form-auth-item">
                    ...
                    <div class="auth-item-input">
                        <input id="email" value="{{ Auth::user()->email }}" type="email" class="form-control @error('email') is-invalid @enderror"
