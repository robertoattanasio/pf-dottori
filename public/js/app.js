...
var _require = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"),
    axios = _require["default"]; // VARIABLES


var selectSpecialzations = document.getElementById('selectSpecializations');
var btnSendSearch = document.getElementById('btnSendSearch'); // SEARCH
...
for (i = 0; i < counties.length; i++) {
  orderedCounties.push(counties[i].nome);
}

orderedCounties.sort(); // STAMPA INPUT SELECT ORDERED COUNTIES

for (i = 0; i < orderedCounties.length; i++) {
  selectSpecialzations.innerHTML += "<option value=\"".concat(orderedCounties[i], "\">").concat(orderedCounties[i], "</option>");
}

axios.get('http://localhost:8000/api/').then(function (response) {
  return console.log(response);
}); //  EVENT LISTENER CHIAMATA AJAX
// btnSendSearch.addEventListener('click', function() {
//     console.log(selectSpecialzations.value);
// })
